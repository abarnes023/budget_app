...
def budget():
    ...
    if request.method == "POST":
        ...
        return render_template("budget.html", username=username, monthTitle=currMonth, currMonth=currMonth, monthMin=monthMin, monthMax=monthMax, e_income=e_income, a_income=a_income, e_rent=e_rent, a_rent=a_rent, e_util=e_util, a_util=a_util, e_food=e_food, a_food=a_food, e_ent=e_ent, a_ent=a_ent, e_save=e_save, a_save=a_save, rent=rent, saved=saved)
    ...
    # if reached via GET
        ...
        return render_template("budget.html", username=username, monthTitle=currMonth, currMonth=currMonth, monthMin=monthMin, monthMax=monthMax, e_income=data['e_income'], a_income=data['a_income'], e_rent=data['e_rent'], a_rent=data['a_rent'], e_util=data['e_util'], a_util=data['a_util'], e_food=data['e_food'], a_food=data['a_food'], e_ent=data['e_ent'], a_ent=data['a_ent'], e_save=data['e_save'], a_save=data['a_save'], rent=rent, saved=saved)
